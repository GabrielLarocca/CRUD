...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.contas, function(contas) {
    ...
    out.w("<tr id=\"contas_" +
      ...
      "</td><td><a href=\"#editEmployeeModal\" class=\"edit\" data-toggle=\"modal\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Editar\">&#xE254;</i></a><a href=\"#\" data-ref=\"" +
      marko_escapeXmlAttr(contas.id) +
      "\" data-type=\"remocao\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Deletar\">&#xE872;</i></a></td></tr>");
  });

  out.w("</tbody></table><div class=\"clearfix\"><div class=\"hint-text\">Mostrando <b>1</b> de <b>25</b> entradas</div><ul class=\"pagination\"><li class=\"page-item disabled\"><a href=\"#\">Anterior</a></li><li class=\"page-item\"><a href=\"#\" class=\"page-link\">1</a></li><li class=\"page-item\"><a href=\"#\" class=\"page-link\">2</a></li><li class=\"page-item active\"><a href=\"#\" class=\"page-link\">3</a></li><li class=\"page-item\"><a href=\"#\" class=\"page-link\">4</a></li><li class=\"page-item\"><a href=\"#\" class=\"page-link\">5</a></li><li class=\"page-item\"><a href=\"#\" class=\"page-link\">Próxima</a></li></ul></div></div></div><div id=\"addEmployeeModal\" class=\"modal fade\"><div class=\"modal-dialog\"><div class=\"modal-content\"><form action=\"/contas\" method=\"POST\"><div class=\"modal-header\"> <h4 class=\"modal-title\">Adicionar conta à pagar</h4><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button></div><div class=\"modal-body\"> <div class=\"form-group\"><label>Nome</label><input type=\"text\" id=\"nome\" name=\"nome\" class=\"form-control\" required></div><div class=\"form-group\"><label>data de recebimento</label><input type=\"text\" id=\"dataRecebimento\" name=\"dataRecebimento\" class=\"form-control\" required></div><div class=\"form-group\"><label>Valor</label><input type=\"text\" id=\"valor\" name=\"valor\" class=\"form-control\" required></div><div class=\"form-group\"><label>Celular</label><input type=\"text\" id=\"celular\" name=\"celular\" class=\"form-control\" required></div> </div><div class=\"modal-footer\"><input type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" value=\"Cancelar\"><input type=\"submit\" class=\"btn btn-success\" value=\"Adicionar\"></div></form></div></div></div><div id=\"editEmployeeModal\" class=\"modal fade\"><div class=\"modal-dialog\"><div class=\"modal-content\"><form><div class=\"modal-header\"> <h4 class=\"modal-title\">Editar Conta</h4><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button></div><div class=\"modal-body\"> <div class=\"form-group\"><label>Nome</label><input type=\"text\" class=\"form-control\" required></div><div class=\"form-group\"><label>data de recebimento</label><input type=\"text\" class=\"form-control\" required></div><div class=\"form-group\"><label>Valor</label><input type=\"text\" class=\"form-control\" required></div><div class=\"form-group\"><label>Celular</label><input type=\"text\" class=\"form-control\" required></div> </div><div class=\"modal-footer\"><input type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" value=\"Cancelar\"><input type=\"submit\" class=\"btn btn-info\" value=\"Salvar\"></div></form></div></div></div><div id=\"deleteEmployeeModal\" class=\"modal fade\"><div class=\"modal-dialog\"><div class=\"modal-content\"><form><div class=\"modal-header\"> <h4 class=\"modal-title\">Deletar conta</h4><button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button></div><div class=\"modal-body\"> <p>Você tem certeza que deseja deletar?</p><p class=\"text-warning\"><small>Essa ação não pode ser desfeita!</small></p></div><div class=\"modal-footer\"><input type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" value=\"Cancelar\"><input type=\"submit\" class=\"btn btn-danger\" value=\"Deletar\"> </div></form></div></div></div>");
